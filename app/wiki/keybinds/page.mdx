...
To register a keybind, you must create a `keybinds` section in your project's (or library's) `mod.json`/`lib.json`,
and populate it with the keys you'd like to have in your project/library.
...
You can use `Input` to check if the keybind is pressed:
