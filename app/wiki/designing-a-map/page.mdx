...
<Box>
    ...
    - `enemycollision`: I don't know yet. XD
    - `blockcollision`: I don't know yet. XD
    - `paths`: Where the paths for wandering enemies and other mechanics are defined. Explained in a future Path System tutorial.
