...
export const metadata = {
    title: 'The UI System',
    description: 'A guide to using Kristal\'s UI system.',
}
...
<NoteBox type="warning">
    The UI system is very old and somewhat unsupported. It may be a better idea to make menus yourself using an [object](/wiki/objects).
</NoteBox>
