...
For animated sprites, each frame should be saved as a seperate image, with the frame number being attached to the end of the name (e.g. `idle_1.png`, `idle_2.png`, ...). **Kristal does not support `.gif` for animations**.
