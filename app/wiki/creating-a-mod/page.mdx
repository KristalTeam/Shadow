...
<Box>
## Installing an alternative IDE
---

If you don't want to use VSCode, or you want to use a language-server (LSP) instead of an IDE-specific extension, you should [install Lua-LS](https://luals.github.io/#install) and an editor such as [Helix](https://helix-editor.com/) or [NVim](https://github.com/neovim/neovim).
</Box>
