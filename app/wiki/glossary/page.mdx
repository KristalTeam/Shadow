...
- **Windows 10 and below**: You can open "Command Prompt", which should open your console. <small>(If you want something better for Windows 10, you can also install Windows Terminal, however it is not there by default.)</small>
...
We do not have a Git tutorial (at the moment), but most of the time you should be making one for every project.
...
A "project" is a game made with Kristal. **These are NOT mods of DELTARUNE, and should NOT be referred to as such.** Most of the time, they are *fangames*.

---

### Mod

Due to some old naming hold-overs, we used to refer to projects as "mods".
This is not the case anymore, but you will still see this term used in some places, namely in code.

We changed the name to "project" to avoid confusion with modifying DELTARUNE itself, which is not what we're doing here.

---

### Libraries

Libraries are "sub-projects" of your project. They implement functionality that you can use in your project.
